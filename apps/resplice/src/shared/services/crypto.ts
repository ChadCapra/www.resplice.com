...
export function calculateClientIV(baseIV: Uint8Array, counter: number): Uint8Array {
...
export function calculateServerIV(baseIV: Uint8Array, counter: number): Uint8Array {
	const ivBuf = new ArrayBuffer(12)
	const ivArr = new Uint8Array(ivBuf)
