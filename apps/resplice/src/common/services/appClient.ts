...
import { ConnStatus } from '$shared/events/events.store'
import { ConnCommandType } from '$services/commuters/connCommuter'
import attributesClientFactory from '$modules/attribute/attribute.client'
import contactsClientFactory from '$modules/contact/contact.client'
import invitesClientFactory from '$modules/invite/invite.client'
import userClientFactory from '$modules/user/user.client'

import { ConnMessageType, type ConnCommuter } from '$services/commuters/connCommuter'
...
class AppClient {
	...
	constructor(wsEndpoint: string, connCommuter: ConnCommuter, api: Api, cache: DB, stores: Stores) {
		...
		// initialize clients
		this.attributes = attributesClientFactory(connCommuter, cache, stores.attributes)
