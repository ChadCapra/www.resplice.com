	...
	<main class="bg-white rounded-t-3xl flex-1 flex flex-col p-8 overflow-auto space-y-8">
		<section class="border-b-2 border-gray-200 pb-4">
			...
			<div class="flex flex-col space-y-4">
				...
				<SettingsItem linkTo="/app/settings/archived">Archived Contacts</SettingsItem>
			</div>
		</section>
		<section class="border-b-2 border-gray-200 pb-4">
		...
		<section class="border-b-2 border-gray-200 pb-4">
			...
			<div class="flex flex-col space-y-4">
				<SettingsItem linkTo="/app/settings/download">Download Your Data</SettingsItem>
				<SettingsItem linkTo="/app/settings/sessions">View Sessions</SettingsItem>
