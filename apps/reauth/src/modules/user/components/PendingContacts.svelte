<script lang="ts">
	import type { Contact } from '$modules/user/user.types'
	import Skeleton from '@resplice/components/skeleton/Skeleton.svelte'
	import ContactItem from '$modules/user/components/ContactItem.svelte'
