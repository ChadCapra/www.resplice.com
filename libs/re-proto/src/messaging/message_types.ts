...
import { Address, Phone, Coordinates } from "../attributes/attribute_value";
...
export const DirectMessage = {
  ...
  toJSON(message: DirectMessage): unknown {
    ...
    message.contactUuid !== undefined &&
      (obj.contactUuid = message.contactUuid);
...
export const Text = {
  ...
  toJSON(message: Text): unknown {
    ...
    message.replyToUuid !== undefined &&
      (obj.replyToUuid = message.replyToUuid);
    return obj;
  },
...
export const Event = {
  ...
  toJSON(message: Event): unknown {
    ...
    message.rsvpOptions !== undefined &&
      (obj.rsvpOptions = message.rsvpOptions);
