...
function createBaseAuthorize(): Authorize {
  return {
    authenticatedAt: 0,
...
export const Authorize = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Authorize {
  ...
  toJSON(message: Authorize): unknown {
    const obj: any = {}
  ...
  fromPartial<I extends Exact<DeepPartial<Authorize>, I>>(
    object: I
  ): Authorize {
    const message = createBaseAuthorize()
