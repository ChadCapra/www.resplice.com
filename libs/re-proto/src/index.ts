...
import * as authsession_detailts from './auth/session_detail'
...
import * as splicespending_splice_memberts from './splices/pending_splice_member'
...
export const auth = {
  ...
  session_detail: authsession_detailts,
...
export const splices = {
  ...
  pending_splice_member: splicespending_splice_memberts,
  request: {
